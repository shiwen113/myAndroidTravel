...
import com.gem.home.activity.Travels_Activity;
...
public class HomeTitle_Activity extends LinearLayout implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.home_right:
			...
			intent = new Intent(context, Travels_Activity.class);
			context.startActivity(intent);

			break;
		case R.id.home_left:

			intent = new Intent("com.gem.activityUI.ACTION_START");
			intent.addCategory("com.gem.activityUI.MY_CATEGORY");
			context.startActivity(intent);
